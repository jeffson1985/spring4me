 ...
 * @author gavin
 * @since 0.4.0
 * @create Feb 12, 2012 - 11:28:01 AM
 */
public abstract class AbstractPageConfig implements PageConfig {
    ...
    //
    private Map<String, GroupConfig> groupConfigMap = new HashMap<String, GroupConfig>();
